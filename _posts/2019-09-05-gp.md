...
# Before diving in
I have procrastinated reading up about Gaussian process for many many moons. However, as always, I'd like to think that this is not just due to my procrastination superpowers. Whenever I look up "Gaussian Process" on Google, I find these well-written tutorials with vivid plots that explains everything up until non-linear regression in details, but shies away at the very first glimpse of any sort of information theory. The key takeaway is always, 
